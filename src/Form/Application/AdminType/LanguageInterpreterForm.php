...
class LanguageInterpreterForm extends AbstractType
{
    ...
    public function __construct(
        ...
        private readonly HTMLPurifiersRegistryInterface $purifier, private readonly Sanitazer $sanitazer, private readonly RequestStack $requestStack
    ) {}
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('justification', TextareaType::class, [
                'label' => $this->translator->trans('Opisz, dlaczego potrzebujesz usług tłumacza') . '*',
                'required' => true,
                'constraints' => [
