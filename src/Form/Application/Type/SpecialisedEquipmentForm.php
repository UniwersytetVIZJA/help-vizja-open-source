...
class SpecialisedEquipmentForm extends AbstractType
{
    ...
    public function __construct(
        ...
        private readonly TranslatorInterface $translator, private readonly InventoryRepository $inventoryRepository, private readonly Sanitazer $sanitazer,
    ) {}
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('description', TextareaType::class, [
                'label' => $this->translator->trans(
                        'Opisz, dlaczego potrzebujesz wypożyczyć sprzęt'
        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $event) {
            ...
            $subtypesPerItem = $submitted['subtype'] ?? []; // z Twojego JS: subtype[itemId] => inventoryTypeId
