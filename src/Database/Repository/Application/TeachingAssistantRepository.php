...
class TeachingAssistantRepository extends ServiceEntityRepository
{
    /**
    ...
    {
        parent::__construct($managerRegistry, Application\TeachingAssistant::class);
    }

    /**
     * @param string $applicationId
     * @return Application\TeachingAssistant|null
     */
    public function findOneById(string $applicationId): ?Application\TeachingAssistant
    {
