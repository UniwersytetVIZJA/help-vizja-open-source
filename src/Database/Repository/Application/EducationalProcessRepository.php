...
class EducationalProcessRepository extends ServiceEntityRepository
{
    /**
    ...
    {
        parent::__construct($managerRegistry, Application\EducationalProcess::class);
    }

    /**
     * @param string $applicationId
     * @return Application\EducationalProcess|null
     */
    public function findOneById(string $applicationId): ?Application\EducationalProcess
    {
