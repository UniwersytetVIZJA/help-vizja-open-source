...
class SpecialisedEquipmentRepository extends ServiceEntityRepository
{
    /**
    ...
    {
        parent::__construct($managerRegistry, Application\SpecialisedEquipment::class);
    }

    /**
     * @param string $applicationId
     * @return Application\SpecialisedEquipment|null
     */
    public function findOneById(string $applicationId): ?Application\SpecialisedEquipment
    {
