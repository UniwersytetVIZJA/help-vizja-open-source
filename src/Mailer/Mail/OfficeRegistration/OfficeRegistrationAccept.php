...
readonly class OfficeRegistrationAccept implements MailContentInterface {
    ...
    public function getSubject(): string
    {
        return match ($this->locale){
            NotificationLanguageEnum::Angielski->value => 'Appointment Confirmation by the Office for Students with Disabilities',
            default => 'Akceptacja wizyty w Biurze ds. Osób z Niepełnosprawnościami',
        };
    }
    ...
    {
        return match ($this->locale) {
            NotificationLanguageEnum::Angielski->value => 'mailer/office-registration/eng/accept-registration-eng.html',
            default => 'mailer/office-registration/accept-registration.html',
        };
    }
